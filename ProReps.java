...
public class ProReps implements ObservingNewsStation {
	
	private int[] voteNums;
	private String[] voteNames;
	private String legalMessage;
	private Cheating cheatec = new ECRepCheating();
	private Cheating cheatpop = new PopRepCheating();
	...
	public StringBuilder displayVotes() {
		...
		StringBuilder s = new StringBuilder("Reporting live from MAGAupdates, a proudly republican news station.\n" + legalMessage + "\n");
