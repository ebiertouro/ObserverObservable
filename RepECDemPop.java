...
public class RepECDemPop implements ObservingNewsStation {
	...
	public StringBuilder displayVotes() {
		...
		StringBuilder s = new StringBuilder("Reporting live from The Gray Lady, a highly sophisticated news station.\n" + legalMessage + "\n");
